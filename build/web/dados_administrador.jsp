                        ...
                        <div class="panel-body">
                            <div class="col-md-4">
                                <form role="form" method="POST"  name="AtualizaAdministrador" action="ServletAtualizaAdministrador">
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input class="form-control" name="admin_nome" value="${user.nome}" disabled/>

                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input class="form-control" name="admin_email" value="${user.email}" disabled/>
                                    </div>
                                    <div class="form-group" style="width:166%">
                                        <label>Endereço</label>
                                        <input class="form-control" name="admin_endereco" value="${user.getEndereco().getEndereco()}" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Cidade</label>
                                        <select name="cidade" id="cidade" class="form-control" disabled>
                                            <option value="${user.getEndereco().getId_cidade()}">${user.getEndereco().getCidade()}</option>
                                        </select>
                                    </div>
                                    <div class="form-group" style="width: 213.333333px">
                                    <label>Senha</label>
                                    <input type="password" class="form-control" name="admin_senha" value="******" disabled/>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalSenha">Alterar Senha</button>
                                    </div>
                                    
                                                                                            
                                                                       
                                    <a class="btn btn-primary" href="ServletAlteraAdministrador">Alterar Dados</a>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal_desativa">Desativar Conta</button>
                                    <div class="modal fade" id="myModal_desativa" role="dialog">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <a class="btn btn-primary" href="ServletExcluirAdministrador?admin_cod=${user.cod}">Sim, Desative minha Conta</a>
                                                </div>
                            ...
                            <div class="col-md-4" style="width:213.333333px">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>RG</label>
                                        <input type="text" class="form-control" name="admin_rg" value="${user.rg}" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Telefone</label>
                                        <input type="text" class="form-control" name="admin_telefone" value="${user.telefone}" disabled/>
                                    </div>
                            ...
                            <div class="col-md-4" style="width:213.333333px">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>CPF</label>
                                        <input type="text" class="form-control" name="admin_cpf" value="${user.cpf}" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Estado</label>
                                        <select name="estado" id="estado" class="form-control" disabled>
                                            <option value="${user.getEndereco().getId_estado()}">${user.getEndereco().getEstado()}</option> 
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-md-4" style="width: 213.333333px">
                                ...
                                <form name="AtualizaSenha" method="post" action="ServletAlteraSenhaAdmin">
                                    <div class="form-group">
