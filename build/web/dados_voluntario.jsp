    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li><a href="#myModal_logout" data-toggle="modal" data-target="#myModal_logout"><em class="fa fa-power-off" >&nbsp;</em> Logout</a>
            </ul>
        </div><!--/.sidebar-->
                        ...
                        <div class="panel-body">
                            <div class="col-md-4">
                                <form role="form">
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input class="form-control" name="vol_nome" value="${user.nome}" disabled />
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input class="form-control" name="vol_email" value="${user.email}" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Especialidade 1</label>
                                        <input class="form-control" name="vol_espec1" value="${ user.especialidades.get(0).getEspecialidade()}" disabled/>
                                    </div>
                                    <div class="form-group" style="width:166%">
                                        <label>Endereço</label>
                                        <input class="form-control" name="vol_endereco" value="${user.getEndereco().getEndereco()}" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Cidade</label>
                                        <input class="form-control" name="vol_endereco" value="${user.getEndereco().getCidade().getNome()}" disabled/>
                                    </div>
                                    <div class="form-group" style="width:166%">
                                        <label>Quem Sou</label>
                                        <textarea class="form-control" cols="50" rows="5" style="resize: none" disabled>${user.descricao}</textarea>
                                    </div>
                                    <div class="form-group" style="width: 213.333333px">
                                        <label>Senha</label>
                                        <input type="password" class="form-control" name="vol_endereco" value="******" disabled/>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalSenha">Alterar Senha</button>
                                    </div>


                                    <a class="btn btn-primary" href="ServletAlteraVoluntario">Alterar Dados</a>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Desativar Conta</button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <a class="btn btn-primary" href="ServletExcluirVoluntario?vol_cod=${user.cod}">Sim, Desative minha Conta</a>
                                                </div>
                            ...
                            <div class="col-md-4" style="width:213.333333px">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>CPF</label>
                                        <input type="text" class="form-control" name="vol_cpf" value="${ user.cpf }" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Data de Nascimento</label>
                                        <input type="date" class="form-control" name="vol_dtnasc" value="${ user.dtnasc }" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Especialidade 2</label>
                                        <input class="form-control" name="vol_espec2" value="${user.especialidades.get(1).getEspecialidade()}" disabled/>
                                    </div>
                            ...
                            <div class="col-md-4" style="width:213.333333px">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>RG</label>
                                        <input type="text" class="form-control" name="vol_rg" value="${user.rg}" disabled/>

                                    </div>
                                    <div class="form-group">
                                        <label>Telefone</label>
                                        <input type="text" class="form-control" name="vol_telefone" value="${user.telefone}" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Especialidade 3</label>
                                        <input class="form-control" name="vol_espec3" value="${user.especialidades.get(2).getEspecialidade()}" disabled/>
                                    </div>
                                    <div class="form-group">
                                        <label>Estado</label>
                                        <input type="text" class="form-control" name="vol_estado" value="${user.getEndereco().getEstado().getNome()}" disabled/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-md-4" style="width: 213.333333px">
                                ...
                                <form name="AtualizaSenha" method="post" action="ServletAlteraSenhaVol">
                                    <div class="form-group">
