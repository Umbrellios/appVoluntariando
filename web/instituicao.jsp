...
<html>
    <head>
        ...
        <title>Voluntariando <--> Insituicao</title>
    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                <li class="active"><a href="voluntario.jsp"><em class="fa fa-dashboard">&nbsp;</em> Painel</a></li>
                <li><a href="widgets.jsp"><em class="fa fa-calendar">&nbsp;</em> Participações</a></li>
                <li>
                    <c:if test="${userperfil=='inst'}">
                        ...
                        <c:if test="${userperfil=='vol'}">
                            ...
                            <c:if test="${userperfil=='admin'}">
                                ...
                                <em class="fa fa-toggle-off">&nbsp;</em> Dados Cadastrais</a>
                            </li>
                                        ...
                                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                                            <div class="panel panel-blue panel-widget border-right">
                                                <div class="row no-padding"><em class="fa fa-xl fa-comments color-orange"></em>
                                                    ...
                                                    <div class="text-muted">Comentarios Efetuados</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                                            <div class="panel panel-orange panel-widget border-right">
                                                <div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
                                                    ...
                                                    <div class="text-muted">Instituições Curtidas</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
