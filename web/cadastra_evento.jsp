                    ...
                    <c:if test="${userperfil=='inst'}">
                        ...
                        <c:if test="${userperfil=='vol'}">
                            ...
                            <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h1 class="page-header">Cadastro de Eventos</h1>
                                    </div>
                                </div><!--/.row-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Dados do Evento</div>
                                <div class="panel-body">
                                    <form role="form" method="POST" action="ServletCadastraEvento" name="CadastraEvento">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Idade Minima</label>
                                                <input class="form-control" type="text" name="even_idade_faixa1"/>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group" style="width: 241%">
                                                ...
                                                <input class="form-control" type="text" name="even_local"/>
                                            </div>
                                            <div class="form-group" style="width: 241%">
                                                <label>Descrição</label>
                                                <textarea class="form-control" name ="even_descricao" cols="50" rows="5" style="resize: none"> </textarea>
                                            </div>
                                                <div class="form-group">
                                                <a href="ServletEvento" class="btn btn-primary">Cancelar</a>
                                                </div>
                                                <div class="form-grou">
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal_Cadastrar">Cadastrar</button>
                                                    <div class="modal fade" id="myModal_Cadastrar" role="dialog">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Os dados cadastrados estão todos corretos?</p>
                                                                    <input type="submit" class="btn btn-primary" value="Sim, confirme o Evento"/>
                                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="even_idade_faixa2"/>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Data</label>
                                                <input class="form-control" type="date" name="even_data"/>
                                            </div>
                                            <div class="form-group">
