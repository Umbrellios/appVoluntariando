<%-- 
    Document   : index
    Created on : 15/09/2017, 00:27:00
    Author     : Home
--%>
        ...
        <header id="header" class="navbar navbar-inverse navbar-fixed-top" role="banner">
            <div class="container menu-container">
                <div class="navbar-header">
                    <!-- Your Logo -->
                    <a href="#hero" ><img src="assets/img/logo.png"/></a>
                </div>
                <!-- Start Navigation -->
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav menu clearfix">
                        ...
                        <li>
                            <a href="#gallery">Instituições</a>
                        </li>
                        <li>
                            <a href="#slider">Comentários</a>
                        </li>
                        <li>
                            <a href="#faq">Manual</a>
                        </li>
                        <li>
                            <a href="#contactarea">Contato</a>
                        </li>
                        <li>
                            <c:if test="${usercod==null}">
                                <a href="login.jsp">Entrar/Cadastro</a>
                            </c:if>
                            <c:if test="${usercod!=null}">
                                <a href="#">Conta</a>
                                <ul class="sub-menu clearfix">
                                    <li>                         
                                        <a href="#">${usernome}</a>
                                        <a href="ServletMinhaConta">Minha Conta</a>
                                        <a href="#myModal" data-toggle="modal" data-target="#myModal"><em class="fa fa-power-off" >&nbsp;</em> Sair</a>
                                    </li>
                                </ul>
                            </c:if>
                        </li>
