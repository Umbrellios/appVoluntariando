                ...
                <div class="navbar-header">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-md-4">
                                <form role="form" method="POST"  name="CadastraAdministrador" action="ServletCadastraAdministrador">
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input class="form-control" name="admin_nome"/>
                                    ...
                                    <div class="form-group" style="width:166%">
                                        ...
                                        <input class="form-control" name="admin_endereco"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Cidade</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password"  requerid placeholder="Insira a nova Senha" class="form-control" id="admin_senha" name="admin_senha"/>
                                    </div>
                            ...
                            <div class="col-md-4" style="width:213.333333px">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>RG</label>
                                        <input type="text" class="form-control" name="admin_rg"/>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-md-4" style="width:213.333333px">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>CPF</label>
                                        <input type="text" class="form-control" name="admin_cpf"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Estado</label>
...
<script>
    function validaSenha(input) {
        if (input.value != document.getElementById('admin_senha').value) {
